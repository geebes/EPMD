...
We developed a population-genetic model of global plankton dispersal that accounts for oceanic dispersal, selection and drift \citep{Cherry:2003}. We initially considered a scenario where buoyant cells are transported within the surface layer of a model ocean. Each grid box supports a predefined but spatially inhomogeneous carrying capacity of $\mathbf{n}$ individuals, based on the estimated global distribution of 0.6 micron diameter \textit{prochlorococcus} cells. 
